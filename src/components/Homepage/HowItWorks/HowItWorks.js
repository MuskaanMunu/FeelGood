			...
			<div className="how-it-works-box">
				<div className="row justify-content-center">
					...
					<div className="col-lg-7 col-md-7 col-sm-12 p-0 ml-lg-0 ml-md-1 ml-sm-3 section-description">
						<p>
							FeelGood provides a decentralized platform for musicians to upload their art up on the internet for trading. Users/Fans just need to create a digital wallet to trade the
						...
						<p>
							...
							will have to pay a small gas fee (almost negligible) while uploading their song. After paying the gas fee, the NFT will be created and featured in the FeelGood library.
