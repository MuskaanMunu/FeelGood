			...
			<div className="mt-2">
				...
				{/*<div className="on-sale-div mt-3">
					<p>
						...
						<Tooltip
							labelText=""
							message={`Do you want to keep the NFT on the FeelGood marketplace for sale? If you choose no, then interested buyers will not be able to buy this NFT until you put it back up on the marketplace again.`}
						/>
					</p>
